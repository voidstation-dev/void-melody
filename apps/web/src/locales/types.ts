...
export type TranslationSchema = {
  ...
  voiceLab: {
    ...
    designPromptPlaceholder: string;
    designPromptHint: string;
    designPreviewTextLabel: string;
    designPreviewCountLabel: string;
    designPreviewInstructionLabel: string;
    designGeneratingPreview: string;
    designGeneratePreview: string;
    designCandidateLabel: string;
    designCandidateHint: string;
    designVoiceNameLabel: string;
    designVoiceNamePlaceholder: string;
    designSaved: string;
    designSavedHint: string;
  };
  voices: {
    title: string;
    subtitle: string;
    ...
    sampleText: string;
    newVoice: string;
    createVoiceTitle: string;
    createVoiceSubtitle: string;
    voiceDesignCard: string;
    voiceDesignCardDesc: string;
    voiceDesignCardEta: string;
    instantCloneCard: string;
    instantCloneCardDesc: string;
    instantCloneCardEta: string;
    professionalCloneCard: string;
    professionalCloneCardDesc: string;
    voiceRemixCard: string;
    voiceRemixCardDesc: string;

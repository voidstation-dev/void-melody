...
from errors import OMNI_PATH_OUTSIDE_ROOT, WorkerError
...
def get_allowed_roots() -> list[Path]:
    ...
    # If not explicitly configured, allow everything (or default safe roots)
    return []


def validate_path(path_str: str, *, must_exist: bool = False, param_name: str = "path") -> Path:

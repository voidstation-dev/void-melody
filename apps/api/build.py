...
def get_pyinstaller_command() -> list[str]:
    return [
        ...
        "--hidden-import=app.models.audio_cache",
        "--hidden-import=app.media.cache",
        "--hidden-import=app.media.pipeline",
        "--hidden-import=app.scheduler.policies",
        "--hidden-import=app.scheduler.cancellation",
        "--hidden-import=app.scheduler.lanes",
        "--hidden-import=app.scheduler.scheduler",
        "--hidden-import=app.utils.timings",
        "--hidden-import=app.db.maintenance",
        "--hidden-import=app.db.repositories",
        "--hidden-import=app.db.repositories.jobs",
        "--hidden-import=app.db.repositories.batches",
        "--hidden-import=app.db.repositories.voices",
        "--hidden-import=app.db.repositories.cache",
